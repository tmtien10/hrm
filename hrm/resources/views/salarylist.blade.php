                    ...
                    <div>
                      ...
                      <table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dynamic-table_info">
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td >{{$pb->ID_NV}}</td>
                            <td class="hidden-480">{{number_format($pb->LUONG_CO_BAN)}}</td>
                            <td class="hidden-480">{{$pb->SO_NGAY_CONG}}</td>
                            ...
                            <td class="center">
                              <div class="hidden-sm hidden-xs action-buttons">
                                ...
                                <a href="#" data-href="delslip/{{$pb->STT}}" data-toggle="modal" data-target="#confirm-delete" class="red">
