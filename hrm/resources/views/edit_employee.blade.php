      ...
      <div id="myTabContent" class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
           ...
           <div class="form-group">
                      ...
                      @if($nv->ANH_DAI_DIEN != '')
                  <center> <img id="img" class="editable img-responsive" src="http://localhost:81/hrm/image/user/{{$nv->ANH_DAI_DIEN}}" alt="{{$nv->ANH_DAI_DIEN}}" width="200" /></center>
                  @else
                  <center><img class="editable img-responsive" src="http://localhost:81/hrm/hrm/public/image/user/noimage.png"  width="200"/></center>
                  @endif
                  </div>
